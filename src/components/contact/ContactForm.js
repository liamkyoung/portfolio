  ...
  return (
    <div className=''>
      <form className='' ref={form} onSubmit={sendEmail}>
        <div className='flex-col md:flex-row flex -mx-5 lg:mx-3 items-start justify-center max-w-full'>
        ...
        <div className='m-0 lg:my-5 justify-center'>
          <h1 className='font-paytone ml-1'>message</h1>
          <textarea className='inputField min-h-1/4 resize-none flex justify-center' name='message' />
