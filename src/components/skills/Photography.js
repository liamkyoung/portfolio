    ...
    <div className='skillWrapper'>
      ...
      <div className='mb-10'>
        <h3 className='skillDesc'>
          I was taught how to use a camera in high school and ever since, I get
          thrilled when I pick up the camera and shoot. I photograph landscapes,
          people, and the stars. Contact me if you have a job you need handled!
        </h3>
      </div>
    </div>
  )
